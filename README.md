...
## WARNING
The repository should not be used to be as a boundary to in an investigation.
Attacks may need more analysis therefore this should cover the baseline of events.

### Please use <a href="./FrameWork.md"> The FrameWork </a>to guide you on how to investigate the windows logs
